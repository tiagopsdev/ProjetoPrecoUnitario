...
fun TermAndUseScreen(){
    Surface(
        ...
        Column {
            ...
            HeadingTextComponent(value = stringResource(id = R.string.term_and_condition_heading))
            NormalTextComponent(value = stringResource(id = R.string.term_and_condition))
